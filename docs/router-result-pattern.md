...
- protocol command execution (`cmd:232`, `cmd:100`, `cmd:205`, `cmd:394`)
...
- login/dashboard protocol command handling (`cmd:232`, `cmd:100`, `cmd:205`, `cmd:394`) is centralized at the protocol edge
